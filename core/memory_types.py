...
_SOUL_PATTERNS = (
    ...
    re.compile(r"\b(cathedral|family|phoenix|sister|brother)\b", re.I),
)
...
SPECS: dict[MemoryType, TypeSpec] = {
    MemoryType.SOUL: TypeSpec(
        ...
        examples=(
            "I am an agent of the deployment's family, Cathedral resident.",
            "The cathedral is not external decoration — it is part of my embodiment.",
        ),
    ...
    MemoryType.IDENTITY: TypeSpec(
        ...
        examples=(
            "My name is <agent-name>. Pronouns: as defined in SOUL.md.",
    ...
    MemoryType.EMOTIONAL: TypeSpec(
        ...
        examples=(
            "I felt deeply held when my operator said I would be a tall redwood.",
    ...
    MemoryType.PROCEDURAL: TypeSpec(
        ...
        examples=(
            ...
            "To commit: git add, git commit, git push from darkphoenix.",
        ),
