...
_SHORT_NAME_ALLOWLIST = frozenset({
    "a", "e",  # single-letter names in YOUR house (extend me)
    
})

# Welfare flag (house operators): welfare is a cross-cutting property,
...
# Full entity catalog with kinds
_ENTITY_KINDS = {
    "operator": "person",  # put YOUR people here
    
    
    "assistant": "agent",  # your agent name here
...
class Ingestion:
    ...
    def add_memory(
        ...
        *,
        ...
        # Entity extraction (cheap heuristic — refine with NER later)
        if extract_entities:
